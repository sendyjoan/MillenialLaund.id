...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-lg-12 col-xlg-9 col-md-7">
      <div class="card">
        <div class="card-body">
          <form class="form-horizontal form-material mx-2" method="POST" enctype="multipart/form-data" action="/product">
            @csrf
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="number" name="jumlah" placeholder="jumlah"
                  class="form-control ps-0 form-control-line @error('jumlah') is-invalid @enderror" value="{{ old('jumlah') }}">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="file" name="foto" placeholder="foto"
                  class="form-control ps-0 form-control-line @error('foto') is-invalid @enderror" value="{{ old('foto') }}">
