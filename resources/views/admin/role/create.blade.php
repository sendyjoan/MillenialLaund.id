...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-lg-12 col-xlg-9 col-md-7">
      <div class="card">
        <div class="card-body">
          <form class="form-horizontal form-material mx-2" method="POST" action="/role">
            @csrf
            <div class="form-group">
              <label class="col-md-12 mb-0">Role</label>
              <div class="col-md-12">
                <input type="text" name="role" placeholder="role"
                  class="form-control ps-0 form-control-line @error('role') is-invalid @enderror" value="{{ old('role') }}">
