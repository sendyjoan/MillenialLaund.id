...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-lg-12 col-xlg-9 col-md-7">
      <div class="card">
        <div class="card-body">
          <form class="form-horizontal form-material mx-2" method="POST" action="/admin/Product">
            @csrf
            <div class="form-group">
              <label class="col-md-12 mb-0">Product</label>
              <div class="col-md-12">
                <input type="text" name="Product" placeholder="Product"
                  class="form-control ps-0 form-control-line @error('Product') is-invalid @enderror" value="{{ old('Product') }}">
